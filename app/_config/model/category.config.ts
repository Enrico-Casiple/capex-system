import { Category } from "@/lib/generated/api/customHookAPI/graphql";
import {
  ListConfigItem,
  PreviewColumn,
  SearchableColumnDef,
...
const ListModelName = "Manage Category List";
const ListDescription = "Manage your Category effectively with our comprehensive management system.";
...
const ExtraColumns: SearchableColumnDef<Model>[] = [
  ...
  {
    id: "modelNameType",
    header: "ModelNameType",
    accessorKey: "modelNameType",
    meta: { searchable: false, type: "string" },
  },
  {
    id: "isActive",
...
const exportColumns = [
      ...
      { id: "modelNameType", label: "ModelNameType" },
