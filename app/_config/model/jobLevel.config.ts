import { JobLevel } from "@/lib/generated/api/customHookAPI/graphql";
import {
  ListConfigItem,
  PreviewColumn,
  SearchableColumnDef,
...
const ListModelName = "Manage Job Level List";
const ListDescription = "Manage your Job Level effectively with our comprehensive management system.";
...
const ExtraColumns: SearchableColumnDef<Model>[] = [
  ...
  {
    id: "jobcodeTypeId",
    header: "JobcodeTypeId",
    accessorKey: "jobcodeTypeId",
    meta: { searchable: false, type: "string" },
  },
  {
    id: "companyId",
...
const exportColumns = [
      ...
      { id: "jobcodeTypeId", label: "JobcodeTypeId" },
...
export const jobLevel = {
  ...
  transformRowCreate: async (row: Model) => {
    return {
            ...
            jobcodeTypeId: row.jobcodeTypeId ? String(row.jobcodeTypeId) : null,
