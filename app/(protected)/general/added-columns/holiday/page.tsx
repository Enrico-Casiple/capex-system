...
import { holidayTableConfig } from '@/app/_config';
import { Holiday, HolidayCreateInput, HolidayUpdateInput } from '@/lib/generated/api/customHookAPI/graphql';
...
const ModelPage = () => {
  type ModelRequest = Holiday;
  type ModelCreateInput = HolidayCreateInput;
  type ModelUpdateInput = HolidayUpdateInput;
