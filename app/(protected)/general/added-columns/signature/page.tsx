...
import { signatureTableConfig } from '@/app/_config';
import { Signature, SignatureCreateInput, SignatureUpdateInput } from '@/lib/generated/api/customHookAPI/graphql';
...
const ModelPage = () => {
  type ModelRequest = Signature;
  type ModelCreateInput = SignatureCreateInput;
  type ModelUpdateInput = SignatureUpdateInput;
