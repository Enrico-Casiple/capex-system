...
import { locationTableConfig } from '@/app/_config';
import { Location, LocationCreateInput, LocationUpdateInput } from '@/lib/generated/api/customHookAPI/graphql';
...
const ModelPage = () => {
  type ModelRequest = Location;
  type ModelCreateInput = LocationCreateInput;
  type ModelUpdateInput = LocationUpdateInput;
