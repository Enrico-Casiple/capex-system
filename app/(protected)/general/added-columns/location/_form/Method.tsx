...
import { LocationFindUnique } from '@/lib/api/gql/Location.gql';
...
const Method = (props: MethodProps) => {
  ...
  const { form, isViewMode, executingCreate, executingUpdate, handleToSubmit, tableName } =
    useFormMethod({
      ...
      model,
      modelName,
      findUniqueGQL: LocationFindUnique,
      defaultValues,
      findUniqueQueryKey: 'LocationFindUnique',
      createResponseKey: 'LocationCreate',
      updateResponseKey: 'LocationUpdate',
