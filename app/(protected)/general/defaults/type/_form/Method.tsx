...
const Method = (props: MethodProps) => {
  ...
  const { form, isViewMode, executingCreate, executingUpdate, handleToSubmit, tableName } =
    useFormMethod({
      ...
      model,
      modelName,
      findUniqueGQL: TypeFindUnique,
      defaultValues,
      findUniqueQueryKey: 'TypeFindUnique',
      createResponseKey: 'TypeCreate',
      updateResponseKey: 'TypeUpdate',
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 gap-4">
              <CustomStaticSelectInput
                ...
                label="Model Name"
                options={MODEL_NAMES.map((name) => ({ label: name, value: `${name}Type` }))}
                disabled={isViewMode}
              />
