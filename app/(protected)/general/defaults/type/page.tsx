...
import { companyTableConfig, typeTableConfig } from '@/app/_config';
import ListPage from '@/app/_context/ListWrapper';
import { Company, CompanyCreateInput, CompanyUpdateInput, Type, TypeCreateInput, TypeUpdateInput } from '@/lib/generated/api/customHookAPI/graphql';
...
const ModelPage = () => {
  ...
  type ModelCreateInput = TypeCreateInput;
  type ModelUpdateInput = TypeUpdateInput;
