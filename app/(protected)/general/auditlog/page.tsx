...
import { auditLogTableConfig, companyTableConfig } from '@/app/_config';
import ListPage from '@/app/_context/ListWrapper';
import { AuditLog, AuditLogCreateInput, AuditLogUpdateInput, Company, CompanyCreateInput, CompanyUpdateInput } from '@/lib/generated/api/customHookAPI/graphql';
...
const ModelPage = () => {
  type ModelRequest = AuditLog;
  type ModelCreateInput = AuditLogCreateInput;
  type ModelUpdateInput = AuditLogUpdateInput;
