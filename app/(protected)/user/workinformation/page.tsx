...
import { BasicInformation, BasicInformationCreateInput, BasicInformationUpdateInput, WorkInformation, WorkInformationCreateInput, WorkInformationUpdateInput } from '@/lib/generated/api/customHookAPI/graphql';
...
import { workInformationTableConfig } from '@/app/_config';
...
const ModelPage = () => {
  type ModelRequest = WorkInformation;
  type ModelCreateInput = WorkInformationCreateInput;
  type ModelUpdateInput = WorkInformationUpdateInput;
