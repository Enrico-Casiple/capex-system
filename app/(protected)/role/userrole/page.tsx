...
import { UserRole, UserRoleCreateInput, UserRoleUpdateInput } from '@/lib/generated/api/customHookAPI/graphql';
...
import { userRoleTableConfig } from '@/app/_config';
...
const ModelPage = () => {
  type ModelRequest = UserRole;
  type ModelCreateInput = UserRoleCreateInput;
  type ModelUpdateInput = UserRoleUpdateInput;
