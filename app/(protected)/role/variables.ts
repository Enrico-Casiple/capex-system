...
class TableConfig {
  ...
  public readonly modelDescription: string =
    'Role model represents the Roles of the application, containing fields such as name, email, password, and other relevant information. It is used to manage Role accounts and authentication.';
  ...
  public toggleColumnVisibility(columnId: string): Record<string, boolean> {
    return {
      ...
      [columnId]:
        !this.initialColumnVisibility[columnId as keyof typeof this.initialColumnVisibility],
    };
  }
}
