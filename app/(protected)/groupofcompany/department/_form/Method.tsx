...
import { DepartmentFindUnique } from '@/lib/api/gql/Department.gql';
...
import { DepartmentCreateInput } from '@/lib/generated/api/customHookAPI/graphql';
...
const Method = (props: MethodProps) => {
  ...
  const { form, isViewMode, executingCreate, executingUpdate, handleToSubmit, tableName } =
    useFormMethod({
      ...
      model,
      modelName,
      findUniqueGQL: DepartmentFindUnique,
      defaultValues,
      findUniqueQueryKey: 'DepartmentFindUnique',
      createResponseKey: 'DepartmentCreate',
      updateResponseKey: 'DepartmentUpdate',
