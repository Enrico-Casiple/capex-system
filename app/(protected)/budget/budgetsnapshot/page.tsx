...
import { budgetSnapshotTableConfig } from '@/app/_config';
import ListPage from '@/app/_context/ListWrapper';
import { BudgetSnapshot, BudgetSnapshotCreateInput, BudgetSnapshotUpdateInput } from '@/lib/generated/api/customHookAPI/graphql';
...
const ModelPage = () => {
  type ModelRequest = BudgetSnapshot;
  type ModelCreateInput = BudgetSnapshotCreateInput;
  type ModelUpdateInput = BudgetSnapshotUpdateInput;
