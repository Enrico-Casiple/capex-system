...
import { budgetTableConfig } from '@/app/_config';
import ListPage from '@/app/_context/ListWrapper';
import { Budget, BudgetCreateInput, BudgetUpdateInput } from '@/lib/generated/api/customHookAPI/graphql';
...
const ModelPage = () => {
  type ModelRequest = Budget;
  type ModelCreateInput = BudgetCreateInput;
  type ModelUpdateInput = BudgetUpdateInput;
