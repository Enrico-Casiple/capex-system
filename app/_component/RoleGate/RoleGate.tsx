...
const RoleGate = ({ 
  ...
  const { hasPermission, loading } = useUserRolePermission({
    module: modules,
    resource: resources,
    action: actions,
  });
          ...
          <div className="rounded-xl bg-gradient-to-r from-red-50 via-orange-50 to-yellow-50 border border-red-200 p-6 shadow-sm h-screen w-screen">
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600 mb-2">You do not have permission to access this resource.</p>
                {!disableRedirect && (
          ...
          <div className="flex items-center justify-center p-8 h-screen w-screen">
            <div className="text-center space-y-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">You do not have permission to access this resource.</p>
                {!disableRedirect && (
                ...
                {!disableRedirect && (
                  <div className="mb-4">
                    ...
                    <p className="text-xs text-gray-500 mt-2">
                      Redirecting in <span className="font-bold text-red-600">{countdown}</span> seconds
                    </p>
                  </div>
                )}

                <div className="mt-6 pt-6 border-t border-gray-100">
                  <p className="text-xs text-gray-500">💡 Contact your administrator to request access</p>
                </div>
              </div>
            </div>
          </div>
