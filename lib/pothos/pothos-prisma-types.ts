...
export default interface PrismaTypes {
    User: {
        ...
        RelationName: "basicInformations" | "auditLogs" | "actions" | "userRoles";
        ListRelations: "auditLogs" | "actions" | "userRoles";
        Relations: {
            basicInformations: {
    ...
    Company: {
        ...
        RelationName: "groupOfCompany" | "locations" | "departments" | "jobLevels" | "auditLogs" | "workInformations";
    ...
    Department: {
        ...
        RelationName: "company" | "auditLogs" | "workInformations";
    ...
    Position: {
        ...
        RelationName: "auditLogs" | "workInformations";
        ListRelations: "auditLogs" | "workInformations";
        Relations: {
            auditLogs: {
                Shape: AuditLog[];
    ...
    Type: {
        ...
        RelationName: "employmentType" | "workSetupType" | "industryType" | "jobLevels" | "actionType" | "auditLogs" | "rolePermissions";
        ListRelations: "employmentType" | "workSetupType" | "industryType" | "jobLevels" | "actionType" | "auditLogs" | "rolePermissions";
        Relations: {
            employmentType: {
                Shape: WorkInformation[];
                Name: "WorkInformation";
    ...
    Role: {
        ...
        RelationName: "rolePermissions" | "userRoles" | "auditLogs";
        ListRelations: "rolePermissions" | "userRoles" | "auditLogs";
        Relations: {
            rolePermissions: {
                Shape: RolePermission[];
                Name: "RolePermission";
    ...
    UserRole: {
        ...
        RelationName: "user" | "role" | "auditLogs";
        ListRelations: "auditLogs";
        Relations: {
            user: {
                Shape: User | null;
