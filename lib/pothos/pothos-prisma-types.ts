...
export default interface PrismaTypes {
    ...
    Budget: {
        ...
        ListRelations: "crf" | "budgetLedgers" | "budgetSnapshot" | "auditLogs";
        Relations: {
            crf: {
                Shape: CapitalRecoveryFactor[];
                Name: "CapitalRecoveryFactor";
